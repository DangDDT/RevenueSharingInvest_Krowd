...
class PendingWithdrawRequestLayout extends StatelessWidget {
  const PendingWithdrawRequestLayout({Key? key}) : super(key: key);
              ...
              return Container(
                ...
                child: Theme(
                  ...
                  child: ExpansionTile(
                    ...
                    subtitle: Text(
                      "Bạn đã tạo lệnh rút ${formatter.format(pendingWR.amount.toInt())} đ",
                      style: TextStyle(
